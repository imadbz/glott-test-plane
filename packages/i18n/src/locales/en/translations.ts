...
if you are sure your search is right. ",
  ...
  glott_hello: "Hello from Glott! Your translations are managed automatically.",
  glott_cta: "Get Started with Glott",
  glott_tagline: "Every commit reaches every language.",
} as const;
