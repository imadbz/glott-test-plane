...
if you are sure your search is right. ",
  ...
  glott_test_a: "Automatic translations for every pull request.",
  glott_test_b: "Coverage maintained across all languages.",
  glott_test_c: "No changes to your existing stack.",
} as const;
