export default {
  ...
  "body": "こんにちは、インスタンス管理者様",
  "archive_module_description": "完了済みまたはキャンセル済みの",
  "glott_hello": "Glottからこんにちは！翻訳は自動的に管理されます。",
  "glott_cta": "Glottを始める",
  "glott_tagline": "すべてのコミットがすべての言語に届きます。"
} as const;
