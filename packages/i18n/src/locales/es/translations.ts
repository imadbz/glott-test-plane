export default {
  ...
  glott_test_a: "Traducciones automáticas en cada pull request.",
  glott_test_b: "Cobertura mantenida en todos los idiomas.",
  glott_test_c: "Sin cambios en su stack existente.",
} as const;
